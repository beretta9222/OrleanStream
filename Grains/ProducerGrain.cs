...
public class ProducerGrain : Grain, IProducerGrain
{
    ...
    public ArraySegment<byte> Serialize(MemoryMessageBody body) => throw new NotImplementedException();
    public MemoryMessageBody Deserialize(ArraySegment<byte> bodyBytes) => throw new NotImplementedException();
}
